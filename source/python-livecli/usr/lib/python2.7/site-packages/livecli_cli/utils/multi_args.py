...
def command_session(session, old_data):
    ...
    valid_cmd = {
        ...
        "fc2-password": "set_plugin_option_value",
        "fc2-username": "set_plugin_option_value",
        ...
        "fc2-purge-credentials": "set_plugin_option_store_true",
    ...
    set_plugin_option = {
        ...
        "fc2-password": ("fc2", "password"),
        "fc2-username": ("fc2", "username"),
