...
def setup_plugin_options():
    ...
    if args.bbciplayer_hd:
        livecli.set_plugin_option("bbciplayer", "hd", True)
    ...
    if args.btsports_email:
        livecli.set_plugin_option("btsports", "email", args.btsports_email)
    ...
    if btsports_password:
        livecli.set_plugin_option("btsports", "password", btsports_password)
